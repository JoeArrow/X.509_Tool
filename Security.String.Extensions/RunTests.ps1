...
$path = 'C:\Usage\_Source\CSharp\JoeWare\Security\Security.String.Extensions\Security.String.Extensions_UT\'
...
$testRunner = "C:\Usage\_Source\PowerShell\UnitTesting\Functional\Run_VSTest.ps1"
